      ...
      <div className="min-h-screen bg-slate-950 text-white overflow-x-hidden">
        ...
        <nav className="fixed top-0 inset-x-0 z-50 h-16 flex items-center backdrop-blur-xl bg-slate-950/80 border-b border-white/5">
          <div className="max-w-7xl mx-auto w-full px-6 flex items-center justify-between gap-6">
            ...
            <div className="hidden md:flex items-center gap-4 flex-shrink-0">
              ...
              <Link href="/register"
                className="bg-white text-slate-900 font-semibold text-sm px-5 py-2 rounded-full hover:bg-slate-100 transition-all duration-150 shadow-sm">
                Start Free Trial
              </Link>
            </div>
          ...
          {mobileOpen && (
            <div className="absolute top-16 inset-x-0 bg-slate-900/95 backdrop-blur-xl border-b border-white/5 px-6 py-5 flex flex-col gap-4 md:hidden">
              ...
              <div className="flex gap-3 pt-3 border-t border-white/10">
                ...
                <Link href="/register"
                  className="bg-white text-slate-900 font-semibold text-sm px-4 py-2 rounded-full hover:bg-slate-100 transition-all">
                  Start Free Trial
                </Link>
              </div>
            </div>
        ...
        <section className="relative min-h-screen flex items-center justify-center pt-16 pb-12 overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 text-center w-full">
            ...
            {/* CTAs */}
            <div className="fu d4 flex flex-col sm:flex-row gap-4 justify-center mt-10">
              <Link href="/register"
                className="bg-blue-600 hover:bg-blue-500 text-white font-semibold px-8 py-4 rounded-full text-base shadow-xl shadow-blue-500/25 transition-all duration-200 hover:scale-105 hover:shadow-blue-500/40">
                Start Free Trial — 14 Days
              </Link>
              <a href="#features"
                className="text-slate-300 hover:text-white text-base flex items-center justify-center gap-1.5 transition-colors duration-150 hover:underline underline-offset-4">
                See how it works →
              </a>
            </div>
