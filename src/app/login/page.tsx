      ...
      <div className="w-full max-w-[380px] p-4">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 space-y-5">
          ...
          <div className="flex items-center justify-between text-xs">
            <Link href="/forgot-password" className="text-slate-500 hover:text-blue-400 transition-colors">
              Forgot password?
            </Link>
            <Link href="/register" className="text-slate-500 hover:text-blue-400 transition-colors">
              Create account
            </Link>
          </div>
        </div>
