        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-800">
              {["Name", "Part Number", "Description", "Unit Price", "Stock", "Status"].map((h) => (
          ...
          <tbody>
            ...
            {!loading && parts.length === 0 && <tr><td colSpan={6} className="px-4 py-8 text-center text-slate-500">No parts found.</td></tr>}
            {parts.map((p) => (
