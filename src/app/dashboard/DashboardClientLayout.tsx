...
export default function DashboardClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const nav = [
    ...
    { href: "/dashboard/suppliers", label: t("suppliers"), icon: <Truck className={IC} /> },
    ...
    { href: "/dashboard/certification", label: t("certification"), icon: <Award className={IC} /> },
    { href: "/dashboard/messages", label: t("messages"), icon: <MessageSquare className={IC} /> },
    ...
    ...(user.role === "ADMIN" ? [
      ...
      { href: "/dashboard/pricing", label: t("pricing"), icon: <Tag className={IC} /> },
    ...
    { href: "/dashboard/contracts", label: t("contracts"), icon: <FileText className={IC} /> },
    { href: "/dashboard/branches", label: t("branches"), icon: <Building2 className={IC} /> },
    { href: "/dashboard/pos", label: t("pointOfSale"), icon: <ShoppingCart className={IC} /> },
    { href: "/dashboard/shifts", label: t("shifts"), icon: <Clock className={IC} /> },
    { href: "/dashboard/academy", label: t("academy"), icon: <GraduationCap className={IC} /> },
