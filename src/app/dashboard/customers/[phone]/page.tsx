        ...
        <div className="grid grid-cols-2 gap-4 animate-pulse">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 space-y-3">
            ...
            <div className="space-y-2">
              <div className="space-y-1"><div className="h-2 w-10 bg-slate-200 dark:bg-slate-800 rounded" /><div className="h-3 w-28 bg-slate-200 dark:bg-slate-700 rounded" /></div>
              <div className="space-y-1"><div className="h-2 w-10 bg-slate-200 dark:bg-slate-800 rounded" /><div className="h-3 w-36 bg-slate-200 dark:bg-slate-700 rounded" /></div>
            </div>
          </div>
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="space-y-1"><div className="h-2 w-20 bg-slate-200 dark:bg-slate-800 rounded" /><div className="h-5 w-16 bg-slate-200 dark:bg-slate-700 rounded" /></div>
              ))}
            </div>
          </div>
        </div>
            ...
            {loading && [...Array(3)].map((_, i) => (
              <tr key={i} className="border-b border-slate-200/50 dark:border-slate-800/50 animate-pulse">
                <td className="px-4 py-3 space-y-1.5">
                  <div className={`h-3 bg-slate-200 dark:bg-slate-700 rounded ${["w-32","w-28","w-36"][i]}`} />
                ...
                <td className="px-4 py-3"><div className="h-5 w-16 bg-slate-200 dark:bg-slate-800 rounded-full" /></td>
                <td className="px-4 py-3"><div className="h-3 w-6 bg-slate-200 dark:bg-slate-800 rounded" /></td>
                <td className="px-4 py-3"><div className={`h-3 bg-slate-200 dark:bg-slate-800 rounded ${["w-16","w-20","w-14"][i]}`} /></td>
