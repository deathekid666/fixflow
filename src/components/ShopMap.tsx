...
export default function ShopMap({ lat, lng, name }: Props) {
  ...
  return (
    <>
      ...
      <div ref={mapRef} className="w-full h-64 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700" />
    </>
  );
}
